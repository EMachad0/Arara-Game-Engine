...
fn add_shapes(mut commands: Commands) {
    ...
    commands.spawn_bundle(SimpleMeshBundle {
        mesh: Box::new(Cylinder::new(32, floor_height, 42., 50.)),
        transform: Transform {
        ...
        for j in 0..2 {
            ...
            .with_children(|tower| {
                ...
                for i in 0..amount {
                    ...
                    tower.spawn_bundle(SimpleMeshBundle {
                        mesh: Box::new(Cuboid::new(block_width, 2.0, block_width)),
    ...
    .insert_bundle(SimpleMeshBundle {
        mesh: Box::new(Cuboid::new(wall_lenght, wall_height, wall_thickness)),
    ...
    commands.spawn().insert(Wall)
    .insert_bundle(SimpleMeshBundle {
        mesh: Box::new(Cuboid::new(wall_thickness, wall_height, wall_lenght)),
    ...
    commands.spawn().insert(Wall)
    .insert_bundle(SimpleMeshBundle {
        mesh: Box::new(Cuboid::new(gate_wall_lenght, wall_height, wall_thickness)),
    ...
    commands.spawn().insert(Wall)
    .insert_bundle(SimpleMeshBundle {
        mesh: Box::new(Cuboid::new(gate_lenght, wall_height - gate_height, wall_thickness)),
        ...
        for i in 0..2 {
            for j in 0..5 {
                ...
                pivot.spawn_bundle(SimpleMeshBundle {
                    mesh: Box::new(Cuboid::new(house_width, house_height, house_width)),
                    transform: Transform::from_xyz(x, house_height / 2.0, z),
                    color: Color::WHITE,
                    ..Default::default()
                });
                pivot.spawn_bundle(SimpleMeshBundle {
                    mesh: Box::new(Cylinder::new(4, roof_height, house_width * 1.01, 0.0)),
                    transform: Transform {
    ...
    .with_children(|tower| {
        ...
        for i in 0..2 {
            for j in 0..2 {
                ...
                let z = j as f32 * tower_distance - tower_distance / 2.0;
                tower.spawn_bundle(SimpleMeshBundle {
                    mesh: Box::new(Cylinder::new(6, tower_height, tower_radius, tower_radius)),
                    transform: Transform {
                ...
                tower.spawn_bundle(SimpleMeshBundle {
                    mesh: Box::new(Cylinder::new(6, cap_height, tower_radius * 1.1, 0.0)),
                    transform: Transform {
    ...
    .with_children(|top| {
        ...
        .with_children(|tower| {
            ...
            toptop.spawn_bundle(SimpleMeshBundle {
                mesh: Box::new(Cylinder::new(6, cap_height, tower_radius * 1.5, 0.0)),
                transform: Transform {
