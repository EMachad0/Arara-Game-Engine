...
fn main() {
    ...
    App::builder()
        ...
        .insert_resource(FlyCamera::from_camera(
            Camera::new((0.0, 30.0, 70.0), Deg(-90.0), Deg(-30.0)),
            20.0,
            0.5,
        ))
        .build()
...
fn add_shapes(mut commands: Commands, mut meshes: ResMut<Assets<Mesh>>) {
    ...
    let tower_mesh = meshes.add(Mesh::from(Cylinder::new(16, tower_height, tower_radius, tower_radius)));
    let block_width = 1.0;
            ...
            .with_children(|tower| {
                ...
                for i in 0..amount {
                    ...
                    tower.spawn_bundle(SimpleMeshBundle {
                        ...
                        transform: Transform::from_xyz(x + block_angle.cos() * tower_radius, tower_height, z + block_angle.sin() * tower_radius),
                        color: Color::DARK_GRAY,
                        ..Default::default()
                    });
                }
    ...
    .insert_bundle(SimpleMeshBundle {
        mesh: meshes.add(Mesh::from(Cuboid::new(wall_lenght, wall_height, wall_thickness))),
        transform: Transform::from_xyz(0.0, wall_height / 2.0, -tower_distance / 2.0),
        color: Color::DARK_GRAY,
        ..Default::default()
    });

    let wall_mesh = meshes.add(Mesh::from(Cuboid::new(wall_thickness, wall_height, wall_lenght)));
    ...
    let wall_mesh = meshes.add(Mesh::from(Cuboid::new(gate_wall_lenght, wall_height, wall_thickness)));

    commands.spawn().insert(Wall)
    .insert_bundle(SimpleMeshBundle {
        mesh: wall_mesh.clone(),
        transform: Transform::from_xyz(-(gate_wall_lenght + gate_lenght)/ 2.0, wall_height / 2.0, tower_distance / 2.0),
        color: Color::DARK_GRAY,
        ..Default::default()
    });
    commands.spawn().insert(Wall)
    ...
    commands.spawn().insert(Wall)
    .insert_bundle(SimpleMeshBundle {
        mesh: meshes.add(Mesh::from(Cuboid::new(gate_lenght, wall_height - gate_height, wall_thickness))),
        transform: Transform::from_xyz(0.0, (wall_height - gate_height) / 2.0 + gate_height, tower_distance / 2.0),
        color: Color::DARK_GRAY,
        ..Default::default()
    });
    ...
    let roof_height = 2.0;
    let house_body_mesh = meshes.add(Mesh::from(Cuboid::new(house_width, house_height, house_width)));
    let house_roof_mesh = meshes.add(Mesh::from(Cylinder::new(4, roof_height, house_width * 1.01, 0.0)));
            ...
            for j in 0..5 {
                ...
                pivot.spawn_bundle(SimpleMeshBundle {
                    ...
                    transform: Transform {
                        ...
                        rotation: Quat::from_euler(EulerRot::ZYX, 0.0, FRAC_PI_2 / 2.0, -FRAC_PI_2),
                        ..Default::default()
                    },
                    color: Color::ORANGE,
                    ..Default::default()
    ...
    commands.spawn()
    .insert_bundle(SimpleMeshBundle {
        mesh: meshes.add(Mesh::from(Cuboid::new(house_width, house_height, house_width))),
    ...
    .with_children(|tower| {
        ...
        let tower_body_mesh = meshes.add(Mesh::from(Cylinder::new(6, tower_height, tower_radius, tower_radius)));
        let tower_cap_mesh = meshes.add(Mesh::from(Cylinder::new(6, cap_height, tower_radius * 1.1, 0.0)));
    ...
    .with_children(|top| {
        ...
        let house_height = 5.0;
        top.spawn().insert_bundle(SimpleMeshBundle {
            mesh: meshes.add(Mesh::from(Cuboid::new(house_width, house_height, house_width))),
        ...
        .with_children(|tower| {
            ...
            let tower_mesh = meshes.add(Mesh::from(Cylinder::new(6, tower_height, tower_radius, tower_radius)));
            let tower_cap = meshes.add(Mesh::from(Cylinder::new(6, cap_height, tower_radius * 1.1, 0.0)));
            ...
            toptop.spawn().insert_bundle(SimpleMeshBundle {
                mesh: meshes.add(Mesh::from(Cylinder::new(6, tower_height, tower_radius, tower_radius))),
                transform: Transform {
            ...
            toptop.spawn_bundle(SimpleMeshBundle {
                mesh: meshes.add(Mesh::from(Cylinder::new(6, cap_height, tower_radius * 1.5, 0.0))),
                transform: Transform {
                    translation: vec3(0.0, house_height / 2.0 + tower_height +  cap_height / 2.0, 0.0),
                    rotation: Quat::from_rotation_x(-FRAC_PI_2),
                    ..Default::default()
                },
                color: Color::GOLD,
