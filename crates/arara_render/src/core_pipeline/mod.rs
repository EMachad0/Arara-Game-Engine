...
use glium::{Version, Api, Profile};
pub use phase_items::*;
pub use simple_mesh::*;
pub use main_pass::main_pass;
pub use prepare_phase::prepare_core_pass;

use crate::{ClearColor, RenderStage, render_phase::{sort_phase_system, RenderPhase}};
...
impl Plugin for CorePipelinePlugin {
    fn build(&self, app_builder: &mut AppBuilder) {
        app_builder
            ...
            .add_system_to_stage(RenderStage::PhaseSort, sort_phase_system::<Transparent>.system());
