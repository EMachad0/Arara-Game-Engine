...
use macro_utils::{derive_label, get_named_struct_fields, AraraManifest};
...
pub fn derive_system_label(input: TokenStream) -> TokenStream {
    ...
    let mut trait_path = arara_ecs_path();
...
pub(crate) fn arara_ecs_path() -> syn::Path {
    AraraManifest::default().get_path("arara_ecs")
}
