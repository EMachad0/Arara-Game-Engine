...
///
/// If no [ordering](https://github.com/araraengine/arara/blob/main/examples/ecs/ecs_guide.rs)
...
/// [`add_event`](https://docs.rs/arara/*/arara/app/struct.App.html#method.add_event).
