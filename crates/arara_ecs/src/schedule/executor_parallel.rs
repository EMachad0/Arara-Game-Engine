...
impl ParallelSystemExecutor for ParallelExecutor {
    ...
    fn run_systems(&mut self, systems: &mut [ParallelSystemContainer], world: &mut World) {
        ...
        compute_pool.scope(|scope| {
            ...
            #[cfg(feature = "trace")]
            let span = arara_utils::tracing::info_span!("parallel executor");
            #[cfg(feature = "trace")]
...
impl ParallelExecutor {
    ...
    fn update_archetypes(&mut self, systems: &mut [ParallelSystemContainer], world: &World) {
        #[cfg(feature = "trace")]
        let span = arara_utils::tracing::info_span!("update_archetypes");
        #[cfg(feature = "trace")]
    ...
    fn prepare_systems<'scope>(
        ...
        #[cfg(feature = "trace")]
        let span = arara_utils::tracing::info_span!("prepare_systems");
        #[cfg(feature = "trace")]
        let _guard = span.enter();
